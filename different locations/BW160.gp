...
set output "BW160-95-percent.png"
...
set xlabel "Locations (BW160)" font ",20" offset 0,0.8
...
plot \
  "BW160.txt" u 1  w hist fs pattern 5  lc rgb "#36a2b5"  t "CSI", \
...
set output "BW160-95-percent.eps"
replot
unset output
